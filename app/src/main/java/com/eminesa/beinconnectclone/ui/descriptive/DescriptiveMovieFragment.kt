...
class DescriptiveMovieFragment :
    BaseFragment<FragmentDescriptiveMovieBinding>(FragmentDescriptiveMovieBinding::inflate) {
    override fun FragmentDescriptiveMovieBinding.bindScreen() {
    }
}