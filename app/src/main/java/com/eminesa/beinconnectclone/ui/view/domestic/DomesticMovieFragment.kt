...
@AndroidEntryPoint
class DomesticMovieFragment :
    BaseFragment<FragmentDomesticMovieBinding>(FragmentDomesticMovieBinding::inflate) {
    override fun FragmentDomesticMovieBinding.bindScreen() {
